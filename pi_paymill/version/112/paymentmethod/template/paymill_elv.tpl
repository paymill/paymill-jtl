...
<label>
    <div class="form-row">
        ...
        <input class="account-number" type="text" size="20" value="{__elv_number__}"/>
    </div>
...
<label>
    <div class="form-row">
        ...
        <input class="bank-code" type="text" size="20" value="{__elv_bankcode__}"/>
    </div>
...
<label>
    <div class="form-row">
        ...
        <input class="bank-owner" type="text" size="20" value="{__elv_owner__}"/>
