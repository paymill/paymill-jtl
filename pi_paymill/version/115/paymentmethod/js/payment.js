...
$(document).ready(function()
{
	$('#paymill-card-number').keyup(function() {
		switch (paymill.cardType($('#paymill-card-number').val()).toLowerCase()) {
			case 'visa':
				$('.card-icon').html('<img src="includes/plugins/pi_paymill/version/112/paymentmethod/img/32x20_visa.png" >');
				$('.card-icon').show();
				break;
			case 'mastercard':
				$('.card-icon').html('<img src="includes/plugins/pi_paymill/version/112/paymentmethod/img/32x20_mastercard.png" >');
				$('.card-icon').show();
				break;
			case 'american express':
				$('.card-icon').html('<img src="includes/plugins/pi_paymill/version/112/paymentmethod/img/32x20_amex.png" >');
				$('.card-icon').show();
				break;
			case 'jcb':
				$('.card-icon').html('<img src="includes/plugins/pi_paymill/version/112/paymentmethod/img/32x20_jcb.png" >');
				$('.card-icon').show();
				break;
			case 'maestro':
				...
				break;
			case 'diners club':
				$('.card-icon').html('<img src="includes/plugins/pi_paymill/version/112/paymentmethod/img/32x20_dinersclub.png" >');
				$('.card-icon').show();
				break;
			case 'discover':
				$('.card-icon').html('<img src="includes/plugins/pi_paymill/version/112/paymentmethod/img/32x20_discover.png" >');
				$('.card-icon').show();
				break;
			case 'unionpay':
				$('.card-icon').html('<img src="includes/plugins/pi_paymill/version/112/paymentmethod/img/32x20_unionpay.png" >');
				$('.card-icon').show();
				break;
			case 'unknown':
			default:
	...
	function paymillCc()
	{
		...
		if (false === paymill.validateExpiry($('#paymill-card-expiry-month').val(), $('#paymill-card-expiry-year').val())) {
