<div class="container form">
    <fieldset>
        ...
        <br/>
        <div class="form-row">{__brand_icons__}</div>
        <div class="form-row">
            <div style="float: left; padding-right: 10px;">
                <span class="form-row-label-big">___Credit_Card_Number___</span>
                <br/>
                <input class="form-row-big card-number {__brand__}" id="paymill-card-number" autocomplete="off" type="text" size="20" value="{__cc_number__}"/>
            </div>
            <span class="form-row-label-small">___Card_Verification_Number___<span class="tooltip" title="__CVC_TOOLTIP__">?</span></span>
            <br/>
            <input class="card-cvc form-row-small" id="paymill-card-cvc" type="text" autocomplete="off" size="20" value="{__cc_cvc__}"/>
        </div>
        <div class="form-row">
            <div style="float: left; padding-right: 10px;">
                <span class="form-row-label-big">___Credit_Card_Holder___</span>
                <br/>
                <input class="card-holdername form-row-big"  id="paymill-card-holdername" autocomplete="off" type="text" size="20" value="{__cc_holder__}"/>
            </div>
            <span class="form-row-label-small">___Expiration_Date___</span>
            <br/>
            <input class="card-expiry form-row-small"  id="paymill-card-expiry" autocomplete="off" type="text" size="5" maxlength="5" value="{__cc_expiry__}"/>
        </div>
    </fieldset>
</div>
